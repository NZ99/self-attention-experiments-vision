...
from models import ViT, BoTNet, CeiT, TNT, CaiT, CvT, MLPMixer
...
def create_model(model_name: str,
    ...
    if model_name == 'vit_b_patch32':
        ...
        return ViT(num_classes=num_classes,
                   ...
                   patch_shape=(16, 16),
                   dtype=dtype)
    elif model_name == 'botnet_t3':
        return BoTNet(num_classes=num_classes,
                      stage_sizes=(3, 4, 6, 6),
                      dtype=dtype)
    elif model_name == 'botnet_t4':
        return BoTNet(num_classes=num_classes,
                      stage_sizes=(3, 4, 23, 6),
                      dtype=dtype)
    elif model_name == 'botnet_t5':
        return BoTNet(num_classes=num_classes,
        ...
        return TNT(num_classes=num_classes,
                   ...
                   inner_embed_dim=24,
                   outer_embed_dim=384)
    elif model_name == 'ceit_t':
        return CeiT(num_classes=num_classes,
                    num_layers=12,
                    num_heads=3,
                    embed_dim=192)
    elif model_name == 'ceit_s':
        return CeiT(num_classes=num_classes,
                    num_layers=12,
                    num_heads=6,
                    embed_dim=384)
    elif model_name == 'ceit_b':
        return CeiT(num_classes=num_classes,
                    num_layers=12,
                    num_heads=12,
                    embed_dim=768)
